...
std::unique_ptr<ModuleBitcodeWriterBase> DXILBitcodeWriter::Create(
  ...
  return std::make_unique<DXILBitcodeWriter>(
      M, Buffer, StrtabBuilder, Stream, ShouldPreserveUseListOrder, Index,
