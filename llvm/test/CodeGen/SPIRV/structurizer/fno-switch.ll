...
; These CFGs model the conditional branch chains emitted by Clang for
; -fno-switch. In particular, the break-only chain used to make an outer
; selection merge branch into a nested selection's merge block.
