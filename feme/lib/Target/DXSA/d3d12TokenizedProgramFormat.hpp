...
#define DECODE_D3D10_SB_TOKENIZED_PROGRAM_TYPE(VerTok)                         \
  ((D3D10_SB_TOKENIZED_PROGRAM_TYPE)(((VerTok) &                               \
...
#define DECODE_D3D10_SB_INSTRUCTION_TEST_BOOLEAN(OpcodeToken0)                     \
  ((D3D10_SB_INSTRUCTION_TEST_BOOLEAN)(((OpcodeToken0) &                           \
...
#define DECODE_D3D10_SB_RESINFO_INSTRUCTION_RETURN_TYPE(OpcodeToken0)                            \
  ((D3D10_SB_RESINFO_INSTRUCTION_RETURN_TYPE)(((OpcodeToken0) &                                  \
...
#define DECODE_D3D10_SB_EXTENDED_OPCODE_TYPE(OpcodeToken1)                     \
  ((D3D10_SB_EXTENDED_OPCODE_TYPE)((OpcodeToken1) &                            \
...
#define DECODE_D3D11_SB_EXTENDED_RESOURCE_DIMENSION(OpcodeTokenN)               \
  ((D3D10_SB_RESOURCE_DIMENSION)(((OpcodeTokenN) &                              \
...
#define DECODE_D3D10_SB_OPERAND_NUM_COMPONENTS(OperandToken0)                  \
  ((D3D10_SB_OPERAND_NUM_COMPONENTS)((OperandToken0) &                         \
...
#define DECODE_D3D10_SB_OPERAND_4_COMPONENT_SELECTION_MODE(OperandToken0)                              \
  ((D3D10_SB_OPERAND_4_COMPONENT_SELECTION_MODE)(((OperandToken0) &                                    \
...
#define DECODE_D3D10_SB_OPERAND_INDEX_DIMENSION(OperandToken0)                   \
  ((D3D10_SB_OPERAND_INDEX_DIMENSION)(((OperandToken0) &                         \
...
#define DECODE_D3D10_SB_OPERAND_INDEX_REPRESENTATION(Dim, OperandToken0)                \
  ((D3D10_SB_OPERAND_INDEX_REPRESENTATION)(((OperandToken0) &                           \
...
#define DECODE_D3D10_SB_EXTENDED_OPERAND_TYPE(OperandToken1)                   \
  ((D3D10_SB_EXTENDED_OPERAND_TYPE)((OperandToken1) &                          \
...
#define DECODE_D3D10_SB_OPERAND_MODIFIER(OperandToken1)                        \
  ((D3D10_SB_OPERAND_MODIFIER)(((OperandToken1) &                              \
...
#define DECODE_D3D11_SB_OPERAND_MIN_PRECISION(OperandToken1)                   \
  ((D3D11_SB_OPERAND_MIN_PRECISION)(((OperandToken1) &                         \
...
#define ENCODE_D3D10_SB_GLOBAL_FLAGS(Flags)                                    \
...
#define DECODE_D3D10_SB_RESOURCE_DIMENSION(OpcodeToken0)                       \
  ((D3D10_SB_RESOURCE_DIMENSION)(((OpcodeToken0) &                             \
...
#define DECODE_D3D10_SB_INPUT_INTERPOLATION_MODE(OpcodeToken0)                 \
  ((D3D10_SB_INTERPOLATION_MODE)(((OpcodeToken0) &                             \
...
#define DECODE_D3D10_SB_CONSTANT_BUFFER_ACCESS_PATTERN(OpcodeToken0)                           \
  ((D3D10_SB_CONSTANT_BUFFER_ACCESS_PATTERN)(((OpcodeToken0) &                                 \
...
#define DECODE_D3D10_SB_GS_OUTPUT_PRIMITIVE_TOPOLOGY(OpcodeToken0)               \
  ((D3D10_SB_PRIMITIVE_TOPOLOGY)(((OpcodeToken0) &                               \
...
#define DECODE_D3D11_SB_TESS_DOMAIN(OpcodeToken0)                              \
  ((D3D11_SB_TESSELLATOR_DOMAIN)(((OpcodeToken0) &                             \
...
#define DECODE_D3D11_SB_TESS_PARTITIONING(OpcodeToken0)                        \
  ((D3D11_SB_TESSELLATOR_PARTITIONING)(((OpcodeToken0) &                       \
...
#define DECODE_D3D11_SB_TESS_OUTPUT_PRIMITIVE(OpcodeToken0)                         \
  ((D3D11_SB_TESSELLATOR_OUTPUT_PRIMITIVE)(((OpcodeToken0) &                        \
...
#define DECODE_D3D10_SB_INSTRUCTION_RETURN_TYPE(OpcodeToken0)                    \
  ((D3D10_SB_INSTRUCTION_RETURN_TYPE)(((OpcodeToken0) &                          \
