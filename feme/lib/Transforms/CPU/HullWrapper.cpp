...
// running this phase's whole wave loop before returning) plus `InputPatch`
// and writes tessellation factors/patch constants -- is not modeled at all
// yet: it needs its own ABI struct and wrapper, deferred alongside the
// domain and geometry wrappers roadmap R34's open-issues list still names
// as "the single largest remaining piece".
//
//===----------------------------------------------------------------------===//
