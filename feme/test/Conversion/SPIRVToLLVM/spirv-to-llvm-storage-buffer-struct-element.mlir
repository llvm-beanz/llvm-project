...
// CHECK: %[[VAL:.*]] = llvm.load %[[ELEM]] : !llvm.ptr<11> -> !llvm.struct<packed (struct<"feme.tight_vector", (array<3 x i32>)>, i32)>
// CHECK: llvm.store %[[VAL]], %[[ELEM]] : !llvm.struct<packed (struct<"feme.tight_vector", (array<3 x i32>)>, i32)>, !llvm.ptr<11>
