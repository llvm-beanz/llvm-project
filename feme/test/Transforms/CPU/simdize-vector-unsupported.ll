...
; operand, a `phi`'s incoming value, an `fcmp`/`icmp` operand, or another
...
; CHECK: error: feme-cpu-simdize: function 'main' has a divergent vector value 'va' used outside a supported insertelement-chain/resource-store/extractelement/select/shufflevector/phi/elementwise/comparison pattern
define void @main() #0 {
