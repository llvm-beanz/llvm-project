//===- feme-spirv-import-fuzzer.cpp - Fuzzer for SPIRVImporter -*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// Fuzzer for feme::SPIRVImporter. FeMe consumes externally-defined binary
...
// (e.g. llvm-dis-fuzzer for bitcode) are fuzzed.
//
//===----------------------------------------------------------------------===//
