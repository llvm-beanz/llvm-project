...
| feature | VK_VERSION_1_0 | `shaderStorageImageMultisample` | no |  |
| feature | VK_VERSION_1_0 | `shaderStorageImageReadWithoutFormat` | no |  |
| feature | VK_VERSION_1_0 | `shaderStorageImageWriteWithoutFormat` | no |  |
