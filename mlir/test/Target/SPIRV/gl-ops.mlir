...
spirv.module Logical GLSL450 requires #spirv.vce<v1.0, [Shader, Linkage, Int16, Int64], []> {
  spirv.func @math(%arg0 : f32, %arg1 : f32, %arg2 : i32, %arg3 : !spirv.ptr<f32, Function>, %arg4 : !spirv.ptr<i32, Function>) "None" {
    ...
    %frexp2 = spirv.GL.Frexp %arg0, %arg4 : f32, !spirv.ptr<i32, Function> -> f32
  ...
  spirv.func @pack_unorm_4x8(%arg0 : i32) "None" {
    ...
    %1 = spirv.GL.PackUnorm4x8 %0 : vector<4xf32> -> i32
    spirv.Return
  }

  spirv.func @pack_unorm_2x16(%arg0 : i32) "None" {
    ...
    %1 = spirv.GL.PackUnorm2x16 %0 : vector<2xf32> -> i32
    spirv.Return
  }
